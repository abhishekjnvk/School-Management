...
(function (Highcharts, UNDEFINED) {
  ...
  var radialAxisMixin = {
    ...
    getOffset: function () {
      ...
      this.center = this.pane.center = CenteredSeriesMixin.getCenter.call(
        this.pane
      );
    },
    ...
    setAxisSize: function () {
      ...
      if (this.isRadial) {
        ...
        this.center = this.pane.center =
          Highcharts.CenteredSeriesMixin.getCenter.call(this.pane);
  ...
  seriesTypes.errorbar = extendClass(seriesTypes.boxplot, {
    ...
    drawDataLabels: seriesTypes.arearange
      ? seriesTypes.arearange.prototype.drawDataLabels
      : noop,
    ...
    translate: function () {
      ...
      for (i = 0, len = points.length; i < len; i++) {
        ...
        if (point.isSum) {
          ...
          shapeArgs.y = yAxis.translate(stackPoint[1], 0, 1);
          shapeArgs.height =
            yAxis.translate(previousIntermediate, 0, 1) - shapeArgs.y;
        ...
        point.plotY = shapeArgs.y =
          mathRound(shapeArgs.y) - (series.borderWidth % 2) / 2;
        ...
        function (proceed, segment, point, i) {
          ...
          if (this.chart.polar) {
            ...
            if (lastPoint && nextPoint) {
              ...
              leftContY =
                plotY + Math.sin(jointAngle) * distanceLeftControlPoint;
              rightContX =
                plotX +
                Math.cos(Math.PI + jointAngle) * distanceRightControlPoint;
              rightContY =
                plotY +
                Math.sin(Math.PI + jointAngle) * distanceRightControlPoint;
