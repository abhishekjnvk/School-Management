<div class="" data-example-id="togglable-tabs">
    <ul class="nav nav-tabs bordered">
        <li class="active"><a href="#tab_basic_info" role="tab" data-toggle="tab" aria-expanded="true"><i
                    class="fa fa-info-circle"></i> <?php echo $this->lang->line('basic_information'); ?></a> </li>
        <li class=""><a href="#tab_guardian_info" role="tab" data-toggle="tab" aria-expanded="true"><i
                    class="fa fa-paw"></i> <?php echo $this->lang->line('guardian_information'); ?></a> </li>
        <li class=""><a href="#tab_parent_info" role="tab" data-toggle="tab" aria-expanded="true"><i
                    class="fa fa-male"></i> <?php echo $this->lang->line('parent_information'); ?></a> </li>
        <li class=""><a href="#tab_attendance" role="tab" data-toggle="tab" aria-expanded="false"><i
                    class="fa fa-check-circle-o"></i> <?php echo $this->lang->line('attendance'); ?></a> </li>
        <li class=""><a href="#tab_mark" role="tab" data-toggle="tab" aria-expanded="false"><i
                    class="fa fa-file-archive-o"></i> <?php echo $this->lang->line('exam_mark'); ?></a> </li>
    ...
    <div class="tab-content">
            ...
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo date($this->global_setting->date_format, strtotime($student->admission_date)); ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="hide-it"><?php echo $student->second_language; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <a target="_blank"
                                href="<?php echo UPLOAD_PATH; ?>/transfer-certificate/<?php echo $student->transfer_certificate; ?>"
                                class="btn btn-success btn-xs"><i class="fa fa-download"></i>
                    ...
                    <tr>
                        ...
                        <td class="hide-it"><?php echo $this->lang->line($student->group); ?></td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="<?php echo UPLOAD_PATH; ?>/guardian-photo/<?php echo $guardian->photo; ?>" alt=""
                                width="70" /><br /><br />
                            <?php } ?>
                        </td>
                        <th><?php echo $this->lang->line('other_info'); ?></th>
        ...
        <div class="tab-pane fade in " id="tab_attendance">
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <td><?php echo $this->lang->line('month'); ?> <i class="fa fa-long-arrow-down"></i> -
                            <?php echo $this->lang->line('date'); ?> <i class="fa fa-long-arrow-right"></i></td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a target="_blank" href="<?php echo site_url('accounting/invoice/view/'.$obj->id); ?>"
                            ...
                            <a target="_blank" href="<?php echo site_url('accounting/invoice/delete/'.$obj->id); ?>"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a target="_blank" href="<?php echo site_url('student/activity/edit/'.$obj->id); ?>"
                            ...
                            <a onclick="get_activity_modal(<?php echo $obj->id; ?>);" data-toggle="modal"
                                data-target=".bs-activity-modal-lg" class="btn btn-success btn-xs"><i
                                    class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                            <?php } ?>
