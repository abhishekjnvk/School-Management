<div class="x_content_ fn-print-area">
    <section class="content invoice profile_img">
        <!-- title row -->
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 invoice-header_ text-center"
    ...
    <section class="content invoice">
        ...
        <div class="row">
            <p class="white text-center">
                ...
                <?php }else{ ?>
                <?php echo $this->global_setting->brand_footer ? $this->global_setting->brand_footer : 'Copyright © '. date('Y').' <a target="_blank" href="#">Pseuso School.</a> All rights reserved.'; ?>
                <?php } ?>
            </p>
        </div>
