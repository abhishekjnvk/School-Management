<?php $arr = array('Student Copy', 'School Copy', 'Bank Copy'); ?>
    ...
    <div class="row invoice-info">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 invoice-col">
            <address>
                ...
                #<?php echo $receipt->custom_invoice_id; ?>
                <br><strong><?php echo $this->lang->line('status'); ?>:</strong>
                <?php echo get_paid_status($receipt->paid_status); ?>
                <br><strong><?php echo $this->lang->line('date'); ?>:</strong>
                <?php echo date($this->global_setting->date_format, strtotime($receipt->date)); ?>
            </address>
        </div>
        <!-- /.col -->
    </div>
...
<section class="content invoice">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $school->currency_symbol; ?><?php echo $paid_amount ? $paid_amount : 0.00; ?>
                            </td>
                        </tr>
                        <tr>
                            <th><?php echo $this->lang->line('due_amount'); ?>:</th>
                            <td><span class="btn-danger"
                                    style="padding: 5px;"><?php echo $school->currency_symbol; ?><?php echo $receipt->net_amount-$paid_amount; ?></span>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div class="row">
        <p class="white text-center">
            ...
            <?php }else{ ?>
            <?php echo $this->global_setting->brand_footer ? $this->global_setting->brand_footer : 'Copyright © '. date('Y').' <a target="_blank" href="#">Pseudo Software</a> All rights reserved.'; ?>
            <?php } ?>
        </p>
    </div>
