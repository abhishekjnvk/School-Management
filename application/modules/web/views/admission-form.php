    ...
    <div class="container">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="admission-form">
                    <div class="row">
                        <div class="col-md-10 col-sm-10 col-xs-12 ">
                            <div class="admission-address">
                                ...
                                <div>
                                    <h4><?php echo $this->lang->line('admission_form'); ?></h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-field">
                                <div class="field-title"><?php echo $this->lang->line('relation_with_guardian'); ?> :
                                </div>
                                <div class="field-value"></div>
                            </div>
                        </div>
        ...
        <div class="row no-print">
            <div class="col-md-12 col-sm-12 text-center margin-top">
                <button class="btn btn-info glbscl-link-btn hvr-bs" onclick="window.print();"><i
                        class="fa fa-print"></i> <?php echo $this->lang->line('print'); ?></button>
                <a class="btn btn-info glbscl-link-btn hvr-bs"
                    href="<?php echo site_url('admission-online'); ?>"><?php echo $this->lang->line('online_admission'); ?></a>
            </div>
        </div>
    </div>
</section>