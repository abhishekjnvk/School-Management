<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-lock"></i><small>
                        <?php echo $this->lang->line('my_profile'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if(isset($info)){ echo 'active'; }?>"><a href="#tab_profile" role="tab"
                                data-toggle="tab" aria-expanded="true"><i class="fa fa-eye"></i>
                                <?php echo $this->lang->line('profile'); ?></a> </li>
                        <li class="<?php if(isset($update)){ echo 'active'; }?>"><a href="#tab_update" role="tab"
                                data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i>
                                <?php echo $this->lang->line('update'); ?></a> </li>
                        <li class=""><a href="#tab_guardian_info" role="tab" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-paw"></i> <?php echo $this->lang->line('guardian'); ?></a> </li>
                        <li class=""><a href="#tab_parent_info" role="tab" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fa-male"></i> <?php echo $this->lang->line('parent'); ?></a> </li>
                        <li class=""><a href="#tab_attendance" role="tab" data-toggle="tab" aria-expanded="false"><i
                                    class="fa fa-check-circle-o"></i> <?php echo $this->lang->line('attendance'); ?></a>
                        </li>
                        <li class=""><a href="#tab_mark" role="tab" data-toggle="tab" aria-expanded="false"><i
                                    class="fa fa-file-archive-o"></i> <?php echo $this->lang->line('exam_mark'); ?></a>
                        </li>
                        <li class=""><a href="#tab_payment" role="tab" data-toggle="tab" aria-expanded="false"><i
                                    class="fa fa-dollar"></i> <?php echo $this->lang->line('payment'); ?> </a> </li>
                        <li class=""><a href="#tab_activity" role="tab" data-toggle="tab" aria-expanded="false"><i
                                    class="fa fa-clipboard"></i> <?php echo $this->lang->line('activity'); ?> </a> </li>
                    </ul>
                    <br />
                    ...
                    <div class="tab-content">
                            ...
                            <div class="x_content">
                                <div class="col-md-12">
                                    <div class="profile_img">
                                        ...
                                        <img src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $profile->photo; ?>"
                                            alt="" width="100" />
                                        <?php }else{ ?>
                                        <img class="" src="<?php echo IMG_URL; ?>default-user.png" width="100"
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date($this->global_setting->date_format, strtotime($profile->admission_date)); ?>
                                            </td>
                                            <th><?php echo $this->lang->line('birth_date'); ?></th>
                                            <td><?php echo date($this->global_setting->date_format, strtotime($profile->dob)); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $profile->discount . ' [ ' . $profile->amount . '% ]'; ?>
                                            </td>
                                            <th class="hide-it"><?php echo $this->lang->line('second_language'); ?></th>
                                            <td class="hide-it"><?php echo $profile->second_language; ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="hide-it"><?php echo $this->lang->line($profile->group); ?></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="<?php echo UPLOAD_PATH; ?>/guardian-photo/<?php echo $guardian->photo; ?>"
                                                alt="" width="70" /><br /><br />
                                            <?php } ?>
                                        </td>
                                        <th><?php echo $this->lang->line('other_info'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="<?php echo UPLOAD_PATH; ?>/father-photo/<?php echo $profile->father_photo; ?>"
                                                alt="" width="70" /><br /><br />
                                            <?php } ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <img src="<?php echo UPLOAD_PATH; ?>/mother-photo/<?php echo $profile->mother_photo; ?>"
                                                alt="" width="70" /><br /><br />
                                            <?php } ?>
                                        </td>
                                    </tr>
                        ...
                        <div class="tab-pane fade in " id="tab_attendance">
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                                ...
                                <thead>
                                    <tr>
                                        <td><?php echo $this->lang->line('month'); ?> <i
                                                class="fa fa-long-arrow-down"></i> -
                                            <?php echo $this->lang->line('date'); ?> <i
                                                class="fa fa-long-arrow-right"></i></td>
                        ...
                        <div class="tab-pane fade in " id="tab_mark">
                            ...
                            <table class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th rowspan="2"><?php echo $this->lang->line('sl_no'); ?></th>
                           ...
                           ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $mark->written_mark+$mark->tutorial_mark+$mark->practical_mark+$mark->viva_mark; ?>
                                    </td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a target="_blank"
                                                href="<?php echo site_url('accounting/invoice/view/'.$obj->id); ?>"
                                            ...
                                            <a target="_blank"
                                                href="<?php echo site_url('accounting/invoice/delete/'.$obj->id); ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a target="_blank"
                                                href="<?php echo site_url('student/activity/edit/'.$obj->id); ?>"
                                            ...
                                            <a onclick="get_activity_modal(<?php echo $obj->id; ?>);"
                                                data-toggle="modal" data-target=".bs-activity-modal-lg"
                                                class="btn btn-success btn-xs"><i class="fa fa-eye"></i>
                                                <?php echo $this->lang->line('view'); ?> </a>
                                            <?php } ?>
                                            <?php if(has_permission(DELETE, 'student', 'activity')){ ?>
                                            <a href="<?php echo site_url('student/activity/delete/'.$obj->id); ?>"
                                                onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"
                                                class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>
                                                <?php echo $this->lang->line('delete'); ?> </a>
                                            <?php } ?>
                            ...
                            <div class="x_content">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="name" id="name"
                                                value="<?php echo isset($profile->name) ?  $profile->name : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="admission_no"
                                                id="admission_no"
                                                value="<?php echo isset($profile->admission_no) ?  $profile->admission_no : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label
                                                for="admission_date"><?php echo $this->lang->line('admission_date'); ?></label>
                                            <input class="form-control col-md-7 col-xs-12" name="admission_date"
                                                id="edit_admission_date"
                                                value="<?php echo isset($profile->admission_date) ?   date('d-m-Y', strtotime($profile->admission_date)) : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="dob" id="edit_dob"
                                                value="<?php echo isset($profile->dob) ?  date('d-m-Y', strtotime($profile->dob)) : ''; ?>"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="gender" id="gender"
                                                ...
                                                <option value="<?php echo $key; ?>"
                                                    <?php if($profile->gender == $key){ echo 'selected="selected"';} ?>>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="blood_group"
                                                ...
                                                <option value="<?php echo $key; ?>"
                                                    <?php if($profile->blood_group == $key){ echo 'selected="selected"';} ?>>
                                                    <?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="religion"
                                                id="add_religion"
                                                value="<?php echo isset($profile->religion) ?  $profile->religion : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="caste" id="add_caste"
                                                value="<?php echo isset($profile->caste) ?  $profile->caste : ''; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title">
                                            <strong><?php echo $this->lang->line('contact_information'); ?>:</strong>
                                        </h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 quick-field"
                                                name="guardian_id" id="guardian_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($guardians as $obj){ ?>
                                                <option value="<?php echo $obj->id; ?>"
                                                    <?php if($profile->guardian_id == $obj->id){ echo 'selected="selected"';} ?>>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="relation_with"
                                                id="relation_with"
                                                value="<?php echo isset($profile->relation_with) ?  $profile->relation_with : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="phone" id="add_phone"
                                                ...
                                                placeholder="<?php echo $this->lang->line('phone'); ?>" type="text"
                                                autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="national_id"
                                                id="national_id"
                                                value="<?php echo isset($profile->national_id) ?  $profile->national_id : ''; ?>"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <textarea class="form-control col-md-7 col-xs-12 textarea-4column"
                                                ...
                                                placeholder="<?php echo $this->lang->line('present_address'); ?>"><?php echo isset($profile->present_address) ?  $profile->present_address : ''; ?></textarea>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <textarea class="form-control col-md-7 col-xs-12 textarea-4column"
                                                ...
                                                placeholder="<?php echo $this->lang->line('permanent'); ?>"><?php echo isset($profile->permanent_address) ?  $profile->permanent_address : ''; ?></textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 quick-field" name="type_id"
                                                id="type_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($types as $obj){ ?>
                                                <option value="<?php echo $obj->id; ?>"
                                                    <?php if($profile->type_id == $obj->id){ echo 'selected="selected"';} ?>>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 quick-field" name="class_id"
                                                id="class_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($classes as $obj){ ?>
                                                <option value="<?php echo $obj->id; ?>"
                                                    <?php if($profile->class_id == $obj->id){ echo 'selected="selected"';} ?>>
                                                    <?php echo $obj->name; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 quick-field"
                                                name="section_id" id="edit_section_id" disabled="disabled">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 hide-it">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="group" id="group"
                                                ...
                                                <option value="<?php echo $key; ?>"
                                                    <?php if($profile->group == $key){ echo 'selected="selected"';} ?>>
                                                    <?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="roll_no" id="roll_no"
                                                readonly="readonly"
                                                value="<?php echo isset($profile->roll_no) ?  $profile->roll_no : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="registration_no"
                                                id="registration_no"
                                                value="<?php echo isset($profile->registration_no) ?  $profile->registration_no : ''; ?>"
                                                placeholder="<?php echo $this->lang->line('registration_no'); ?>"
                                                disabled="disabled" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="role_id" id="role_id"
                                                disabled="disabled">
                                                <?php foreach($roles as $obj){ ?>
                                                <?php if(in_array($obj->id, array(STUDENT))){ ?>
                                                <option value="<?php echo $obj->id; ?>"
                                                    <?php if($profile->role_id == $obj->id){ echo 'selected="selected"';} ?>>
                                                    <?php echo $obj->name; ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="discount" id="discount"
                                                value="<?php echo isset($profile->discount) ?  $profile->amount.'% ('.$profile->discount .')' : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12 hide-it">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="second_language"
                                                id="second_language"
                                                value="<?php echo isset($profile->second_language) ?  $profile->second_language : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="father_name"
                                                id="father_name"
                                                value="<?php echo isset($profile->father_name) ?  $profile->father_name : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="father_phone"
                                                id="father_phone"
                                                value="<?php echo isset($profile->father_phone) ?  $profile->father_phone : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="father_education"
                                                id="father_education"
                                                value="<?php echo isset($profile->father_education) ?  $profile->father_education : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="father_profession"
                                                ...
                                                value="<?php echo isset($profile->father_profession) ?  $profile->father_profession : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="father_designation"
                                                ...
                                                value="<?php echo isset($profile->father_designation) ?  $profile->father_designation : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <input type="hidden" name="prev_father_photo" id="prev_father_photo"
                                                value="<?php echo $profile->father_photo; ?>" />
                                            <?php if($profile->father_photo){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/father-photo/<?php echo $profile->father_photo; ?>"
                                                alt="" width="70" /><br /><br />
                                            <?php } ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="mother_name"
                                                id="mother_name"
                                                value="<?php echo isset($profile->mother_name) ?  $profile->mother_name : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="mother_phone"
                                                id="mother_phone"
                                                value="<?php echo isset($profile->mother_phone) ?  $profile->mother_phone : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="mother_education"
                                                id="mother_education"
                                                value="<?php echo isset($profile->mother_education) ?  $profile->mother_education : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="mother_profession"
                                                ...
                                                value="<?php echo isset($profile->mother_profession) ?  $profile->mother_profession : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="mother_designation"
                                                ...
                                                value="<?php echo isset($profile->mother_designation) ?  $profile->mother_designation : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <input type="hidden" name="prev_mother_photo" id="prev_mother_photo"
                                                value="<?php echo $profile->mother_photo; ?>" />
                                            <?php if($profile->mother_photo){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/mother-photo/<?php echo $profile->mother_photo; ?>"
                                                alt="" width="70" /><br /><br />
                                            <?php } ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title">
                                            <strong><?php echo $this->lang->line('other_info'); ?>:</strong>
                                        </h5>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="email" id="email"
                                                value="<?php echo isset($profile->email) ?  $profile->email : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="username" id="username"
                                                readonly="readonly"
                                                value="<?php echo isset($profile->username) ?  $profile->username : ''; ?>"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="health_condition"
                                                id="health_condition"
                                                value="<?php echo isset($profile->health_condition) ?  $profile->health_condition : ''; ?>"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <textarea class="form-control col-md-6 col-xs-12 textarea-4column"
                                                ...
                                                placeholder="<?php echo $this->lang->line('other_info'); ?>"><?php echo isset($profile->other_info) ?  $profile->other_info : ''; ?></textarea>
...
get_section_by_class('<?php echo $profile->school_id; ?>', '<?php echo $profile->class_id; ?>',
    '<?php echo $profile->section_id; ?>');
<?php } ?>
