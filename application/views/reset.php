    ...
    <div class="login_wrapper">
        <section>
            <center>
                ...
                <img src="<?php echo UPLOAD_PATH.'logo/'.$this->global_setting->brand_logo; ?>"
        ...
        <div class="form login_form">
            <section>
                <h1 class="text-center"><?php echo $this->lang->line('reset_password'); ?></h1>
            </section>
            <section class="login_content">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <input type="password" name="password" required="required" class="form-control has-feedback-left"
                        placeholder="<?php echo $this->lang->line('password'); ?>">
                    <span class="fa fa-asterisk form-control-feedback left" aria-hidden="true"></span>
                </div>

                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <input type="password" name="conf_password" required="required"
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input class="btn btn-primary login-button" type="submit" name="submit"
                        value="<?php echo $this->lang->line('submit'); ?>" />
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <a class="reset_pass btn btn-primary login-button"
                        href="<?php echo site_url('login') ?>"><?php echo $this->lang->line('back_to_login'); ?></a>
                </div>
