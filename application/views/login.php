            ...
            <section class="login_content">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <input type="text" name="username" class="form-control has-feedback-left"
                        placeholder="<?php echo $this->lang->line('username'); ?>" autocomplete="off">
                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <input type="password" name="password" class="form-control has-feedback-left" id="inputSuccess2"
                        placeholder="<?php echo $this->lang->line('password'); ?>" autocomplete="off">
                    <span class="fa fa-asterisk form-control-feedback left" aria-hidden="true"></span>
                </div>
                <div>
                    <div class="text-center">
                        <input class="btn btn-primary btn-lg login-button" type="submit" name="submit"
                            value="<?php echo $this->lang->line('login'); ?>" />
                    </div>
                    <div class="text-right">
                        <a class="reset_pass "
                            href="<?php echo site_url('forgot') ?>"><?php echo $this->lang->line('lost_your_password'); ?></a>
                    </div>
                </div>
