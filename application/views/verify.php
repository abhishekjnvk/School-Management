...
<body class="login">
    ...
    <div class="login_wrapper">
        ...
        <div class="form login_form">
            <section>
                <h1 class="text-center"><?php echo $this->lang->line('enter_purchase_code'); ?></h1>
            </section>
            <section class="login_content">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                    <input type="text" name="purchase_code" class="form-control has-feedback-left"
                        placeholder="<?php echo $this->lang->line('purchase_code'); ?>">
